        ...
        <FormGroup>
            <Label style={{fontSize:"9pt", margin: "0px", color: 'black'}}>{title}</Label>
                <div className="d-flex justify-content-right">
                    {
                        format == "number" ?
                        <NumberFormat readOnly={true} className="custom-input" name={name} style={{fontWeight: "bold", width: width, borderWidth: "3px", textAlign: textAlign}} thousandSeparator={true} prefix={'Rp '} onChange={onChange} displayType="input" value={value} />
                        :
